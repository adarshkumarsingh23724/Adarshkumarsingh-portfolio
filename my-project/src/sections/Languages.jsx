  ...
  return (
    <section id="languages" className="relative bg-black text-white">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[-5%] left-1/2 -translate-x-1/2 w-[80%] max-w-[800px] h-[500px] bg-gradient-to-b from-fuchsia-900/30 via-purple-900/15 to-transparent blur-[120px] rounded-full opacity-80"></div>
      </div>
      <div
        ref={sceneRef}
